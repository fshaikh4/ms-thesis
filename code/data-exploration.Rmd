...
```{r load relevant packages, warning=F}
library(tidyverse)
library(readxl)
library(forecast)
```
...
data_dir_path <- # comment-out appropriate option below
...
cdc_wonder_overdose_deaths_fname <- # comment-out appopriate option below
