...
# Project To-Do List
 ...
 - ~~implement custom addition rules for NAs for combined opioid data (currently any constituent NA means combined is NA); SOLUTION: treat NA as 0 for the sum (since NA is due to low-number supression)~~