...
combined_edvisits_df <- combined_edvisits_df %>%
    mutate(
        combined_rate_per_100k = (combined / annual_popest) * (10**6),
        heroin_rate_per_100k = (heroin / annual_popest) * (10**6),
        nonheroin_opioid_rate_per_100k = (nonheroin_opioid / annual_popest) * (10**6)
    )
